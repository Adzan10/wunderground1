<?php
	 $json_string3 = file_get_contents("http://api.wunderground.com/api/c70c919862002b41/almanac/q/ID/Semarang.json");
	$json_string1 = file_get_contents("http://api.wunderground.com/api/c70c919862002b41/astronomy/q/IA/Mugas.json");
	$json_string2 = file_get_contents("http://api.wunderground.com/api/c70c919862002b41/planner_07010731/q/IA/Mugas.json");
 ...
 $json_string = file_get_contents("http://api.wunderground.com/api/c70c919862002b41/geolookup/conditions/q/IA/Cedar_Rapids.json");
